...
export default function BusinessSignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    if (!agreed) {
      Alert.alert(
        'Agreement required',
        'Please agree to the Host Agreement and Privacy Policy.',
      );
      return;
    }
    ...
    try {
      const res = await auth.register(
        ...
        'expo-mobile',
        'owner', // ← request an owner account
      );
      await saveToken(res.data.token);
      // Land the user on the owner dashboard, which will show the
      // "pending approval" screen until an admin approves them.
    ...
    >
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.title}>List your campsite</Text>
          ...
          >
            ...
            <Text style={styles.termsText}>
              I agree to the{' '}
              <Text style={styles.termsLink}>Host Agreement</Text> and{' '}
          ...
          >
            {loading ? (
              ...
              <Text style={styles.buttonText}>Apply to become a host</Text>
            )}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  checkboxChecked: { backgroundColor: colors.gearupGreen },
